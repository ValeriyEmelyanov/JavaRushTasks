...
public class Solution {
    ...
    public Solution() throws SolutionException {
        try {
            ...
            String msg;
            if (e.getClass() == WrongDataException.class) {
                msg = "WrongDataException: ";
            } else if (e.getClass() == ConnectionException.class) {
                msg = "ConnectionException: ";
            } else {
                msg = "";
            }
            throw new SolutionException(msg + e.getMessage());
        }
    }
