...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        solution.sendMail("ValeriyEmelyanov1xx8@gmail.com", "12345", "emelva@rambler.ru");
    }
    ...
    public static void setAttachment(Message message, String filename) throws MessagingException {
        ...
        String caption = fileNameParts.length > 0 ? fileNameParts[fileNameParts.length - 1] : "file";
